...
public class LoggingAspect {
    ...
    @Before("@annotation(com.usermanagement.utils.aop.LogMethodDetails)")
    public void logMethodCall(JoinPoint joinPoint) throws Throwable {
        logger.info(joinPoint.getSignature() + " is called.");
    }

    @Around("@annotation(com.usermanagement.utils.aop.LogMethodDetails)")
    ...
    @AfterThrowing(value = "@annotation(com.usermanagement.utils.aop.LogMethodDetails)", throwing = "ex")
