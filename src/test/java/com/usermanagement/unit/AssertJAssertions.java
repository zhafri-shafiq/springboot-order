...
public class AssertJAssertions {
    ...
    @Test
    public void assertionWithDescriptionMessage() {
        //given
        int age = 32;
    ...
    @Test
    public void assertionForExceptions() {
        //given
        List<Integer> marks = new ArrayList<>();
        marks.add(80);
        marks.add(70);
        ...
        assertThatExceptionOfType(IndexOutOfBoundsException.class)
                ...
                .withMessage("Index 6 out of bounds for length 5");

        assertThatNoException().isThrownBy(() -> marks.get(4));
    }

    @Test
    public void assertionForLocalDateTime() {
        //given
